...
describe("installed PWA surface", () => {
  it("uses one stable light color for launch and app chrome", () => {
  ...
  it("paints the root before boot and keeps the sticky header opaque", () => {
    const layout = read("src/app/layout.tsx");
  ...
  it("keeps the offline shell and cache generation aligned", () => {
