...
| `schema.ts` | Backward-compatible envelope plus v3 item, audience, pass, audit, and historical evaluation-clock contracts |
...
| `editorial-policy.ts` | v3 composition, score/time tiers, identity, research, evaluation-clock, and selection reconciliation |
